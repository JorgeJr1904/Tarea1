function mostrarDatos() {
    ...
    const nombres = formulario.elements["txt_nombre"].value;
    const apellidos = formulario.elements["txt_apellido"].value;
    ...
    if (window.confirm("Los Siguientes estan correctos?\n\n" +
            "Nombres: " + nombres + "\n" +
            "Apellidos: " + apellidos + "\n" +
